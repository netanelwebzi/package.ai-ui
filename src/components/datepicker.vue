...
<template>
	<div class="cov-vue-date" :class="option.wrapperClass ? option.wrapperClass : {}" @keyup.27="showInfo.check=false">
		<div class="datepickbox">
			<md-button class="md-raised md-primary" @click="showCheck" style="margin-top:2px;">
				{{ date.time || option.placeholder }}
				<md-icon>keyboard_arrow_down</md-icon>
			</md-button>
			<md-tooltip md-direction="bottom">Click to choose another deliveries date</md-tooltip>
